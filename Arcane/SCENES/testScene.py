...
class testScene(SceneModel):
    def Start(self, _gameWindow):
        ...
        self.camera = MouseControl([500, -700], [500, -700], [-250,-50], 10)

        self.tilemap = Loader(self.window.display, "MAPS/testScene.tmx", 50, 350)
        self.tilemap.Render()

        self.player = Player(self.window.display, 288,320)
